...
class Police_U_I_A_Uniform_01_F: Uniform_Base
{
	author = $STR_A3_A_BranFlakes;
	scope = public;
	displayName = "Police Uniform [Argana]";
	picture = "\A3_Police\Characters_F_Police\Uniforms\Data\UI\icon_U_I_P_PoliceUniform_F_CA.paa";
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
	hiddenSelections[] = {camo};
	hiddenSelectionsTextures[] = {"\A3_Police\Characters_F_Police\Uniforms\Data\I_P_PoliceUniform_01_CO.paa"};
	...
	{
		uniformModel = "-";
		uniformClass = Police_I_A_Uniform_01_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class Police_U_I_A_Uniform_02_F: Uniform_Base
{
	author = $STR_A3_A_BranFlakes;
	scope = public;
	displayName = "Police Uniform [Argana] (Rolled-Up)";
	picture = "\A3_Police\Characters_F_Police\Uniforms\Data\UI\icon_U_I_P_PoliceUniform_gloves_F_CA.paa";
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
	hiddenSelections[] = {camo};
	hiddenSelectionsTextures[] = {"\A3_Police\Characters_F_Police\Uniforms\Data\I_P_PoliceUniform_01_CO.paa"};
	...
	{
		uniformModel = "-";
		uniformClass = Police_I_A_Uniform_02_F;
		containerClass = Supply40;
		mass = 40;
	};
};